...
see_also: ["adrs/0001-raise-body-limit.adr.md", "specifications/0001-body-limit-fix.spec.md", "concepts/0002-opencode-attachment-uri-bridge.concept.md"]
deprecated:
  date: null
  reason: null
  superseded_by: null
...
- Current limits: Express body `MCP_BODY_LIMIT` default 50mb; `MAX_BASE64_LENGTH` 48_900_000 chars (~36.5MB raw ≈ 97% of the JSON envelope) — see ADR-0001/ADR-0003
